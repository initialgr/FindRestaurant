...
import com.app.findrestaurant.adapter.MainAdapter
import com.app.findrestaurant.adapter.MainAdapterHorizontal
import com.app.findrestaurant.model.ModelMain
import com.app.findrestaurant.model.ModelMainHorizontal
import com.app.findrestaurant.networking.ApiEndpoint
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private var permissionArrays = arrayOf(ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION)
    ...
    private fun setSearchResto(query: String) {
        ...
        AndroidNetworking.get(ApiEndpoint.BASEURL + ApiEndpoint.CariResto + query + "&lat=" + lat + "&lon=" + lng + "&radius=20000")
            .addHeaders("user-key", "d29e8ea77b1215f891451b038add2b1f")
